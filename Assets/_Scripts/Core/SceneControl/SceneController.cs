...
namespace Core {
    ...
    public class SceneController : MonoBehaviour {
        ...
        public string      startingSceneName = "Prototype"; // The name of the scene that should be loaded first.
        ...
        private void Awake() {
            ...
            // Register basic delegate
            AfterSceneLoad += SetActiveCam;
        }
        ...
        /// <summary>
        /// This is the main external point of contact and influence from the rest of the pro
        ...
        private IEnumerator FadeAndSwitchScenes(string sceneName) {
            faderCanvasGroup.gameObject.SetActive(true); // Make sure the gameObject is active
